...
async def guide(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        f"{name} needs help!\n\n"
        f"@{ADMIN_USERNAME} - a student is requesting your guidance."
    )
...
async def planning(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"@{ADMIN_USERNAME} - {name} asked about study planning.")
...
async def strategy(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"@{ADMIN_USERNAME} - {name} asked about exam strategy.")
...
async def motivation(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"@{ADMIN_USERNAME} - {name} might need some encouragement.")
...
async def resources(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"@{ADMIN_USERNAME} - {name} asked about books and resources.")
...
async def cutoff(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"@{ADMIN_USERNAME} - {name} asked about cutoffs and colleges.")
